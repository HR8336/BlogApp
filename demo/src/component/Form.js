...
const Form = () => {
  ...
  const schema = yup.object().shape({
    ...
    name: yup
      .string()
      .max(32, "name is not more then 32 char")
      .required("please Enter name")
      .min(4, "name is no less then 4 char"),
        ...
        <form onSubmit={handleSubmit(onSubmitHandler)}>
          ...
          <div>
            <input
              name="ch1"
              type="checkbox"
              {...register("ch1", { onBlur: () => console.log(watch("ch1")) })}
            />
            <label>CH1</label>
            <input
              name="ch2"
              type="checkbox"
              {...register("ch2", { onBlur: () => console.log(watch("ch2")) })}
            />
            <label>CH2</label>
